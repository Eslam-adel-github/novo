<div class="kt-header__topbar kt-grid__item">
    ...
    @if(userCan('Add Leads') && userCan('Show Leads'))
        <div class="kt-header__topbar-item kt-header__topbar-item--search dropdown" title="{{trans('main.search_in_lead_by_mobile')}}" id="kt_quick_search_toggle">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                <span class="kt-header__topbar-icon"><i class="flaticon2-search-1"></i></span>
            </div>
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-lg">
                <div class="kt-quick-search kt-quick-search--dropdown kt-quick-search--result-compact" id="kt_quick_search_dropdown">
                    <form method="get" action="{{route('get-lead-by-mobile')}}" class="kt-quick-search__form">
                        <div class="input-group">
                            <input name="mobile" type="text" id="kt-quick-panel-search_lead" class="form-control kt-quick-search__input"  placeholder="{{trans('main.search_in_lead_by_mobile')}}">
                        </div>
                    </form>
                    <div class="kt-quick-search__wrapper kt-scroll" data-scroll="true" data-height="325" data-mobile-height="200"> </div>
                </div>
