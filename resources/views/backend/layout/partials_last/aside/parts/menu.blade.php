    ...
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
        <ul class="kt-menu__nav ">
            <li class="kt-menu__item {{ is_active(userType()::prefix().'dashboard') }}" aria-haspopup="true">
                ...
                @include('backend.layout.partials.aside.parts.menuSections.youtube_hyper_link')
                @include('backend.layout.partials.aside.parts.menuSections.rethink_obesity_hyper_link')
