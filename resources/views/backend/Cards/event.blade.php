                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="{{ route('admin.templete_event.index') }}">{{ trans("main.templete_event") }}</a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        {{ __('main.event_templete_description') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="{{ route('admin.event_type.index') }}">{{ trans("main.event_type") }}</a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        {{ __('main.event_type_description') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="{{ route('admin.calendar') }}">{{ trans("main.event_planned") }}</a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        {{ __('main.event_planned') }}
                                    </div>
                                </div>
                            </div>
                        </div>
