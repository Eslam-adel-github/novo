                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="{{ route('admin.faq.index') }}">{{ trans("main.faq") }}</a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="{{ route('admin.library.index') }}">{{ trans("main.library") }}</a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        {{ __('main.library_description') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="{{ route('admin.category_library.index') }}">{{ trans('main.categories') }} {{ trans('main.library') }}</a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        {{ __('main.category_library_description') }}
                                    </div>
                                </div>
                            </div>
                        </div>
