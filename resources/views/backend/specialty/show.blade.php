    ...
    @component('backend.layout.components.sub-header')
        ...
        @slot('toolbar')
            <li class="kt-nav__item">
                <a href="{{ route('admin.specialty.edit', [$show->id]) }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon-edit"></i>
                    <span class="kt-nav__link-text">{{ __('main.edit') }} {{ __('main.specialty') }}</span>
                </a>
            </li>
            <li class="kt-nav__item">
                <a href="{{ route('admin.specialty.index') }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon-list-2"></i>
                    <span class="kt-nav__link-text">{{ __('main.show-all') }} {{ __('main.specialties') }}</span>
                </a>
            </li>
            <li class="kt-nav__item">
                <a href="{{ route('admin.specialty.create') }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon-add"></i>
                    <span class="kt-nav__link-text">{{ __('main.add_new') }} {{ __('main.specialty') }}</span>
                </a>
            </li>
        @endslot
    @endcomponent
