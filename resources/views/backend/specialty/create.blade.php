    ...
    @component('backend.layout.components.form-portlet')
        ...
        <form class="kt-form" id="kt_form" action="#" method="get">
            <div class="row">
                ...
                <div class="col-xl-8">
                    @include('backend.specialty._partials._fields', [
                        'data' => collect(old()),
                        'action' => 'create',
                    ])
                </div>
...
@section('js_scripts')
    @include('backend.specialty._partials._scripts', [
        'action' => 'create',
        'data' => collect(old()),
        'submitUrl' => route('admin.specialty.store'),
    ])
@endsection
