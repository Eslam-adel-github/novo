...
@section('sub_header')
    @component('backend.layout.components.sub-header')
        ...
        <a href="#" class="kt-subheader__breadcrumbs-link">
            {{ __('main.edit') }} {{ __('main.library') }} #: {{ $edit->id }}
        </a>
    ...
    @component('backend.layout.components.form-portlet')
        ...
        <form class="kt-form" id="kt_form" action="#" method="get">
            <div class="row">
                ...
                <div class="col-xl-8">
                    @include('backend.libraries._partials._fields', [
                        'action' => 'edit',
                    ])
                </div>
                <div class="col-xl-2"></div>
...
@section('js_scripts')
    @include('backend.libraries._partials._scripts', [
        'action' => 'edit',
        'data' => collect($edit),
        'submitUrl' => route('admin.library.update', [$edit->id]),
    ])
@endsection
