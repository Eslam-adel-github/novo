...
@section('sub_header')
    @component('backend.layout.components.sub-header')
        ...
        <a href="{{ route('admin.HCP.index') }}" class="kt-subheader__breadcrumbs-link">
            {{ __('main.HCP') }}
        </a>
        <span class="kt-subheader__breadcrumbs-separator"></span>
        <a href="#" class="kt-subheader__breadcrumbs-link">
            {{ __('main.edit') }} {{ __('main.HCP') }} : {{VarByLang(getData(collect($edit),"name"))}}
        </a>

        @slot('toolbar')
            <li class="kt-nav__item">
                <a href="{{ route('admin.HCP.index') }}" class="kt-nav__link">
    ...
    @component('backend.layout.components.form-portlet')
        ...
        <form class="kt-form" id="kt_form" action="#" method="get">
            <div class="row">
                ...
                <div class="col-xl-8">
                    @include('backend.hcp._partials._fields', [
                        'action' => 'edit',
                    ])
                </div>
                <div class="col-xl-2"></div>
...
@section('js_scripts')
    @include('backend.hcp._partials._scripts', [
        'action' => 'edit',
        'data' => collect($edit),
        'submitUrl' => route('admin.HCP.update', [$edit->id]),
    ])
@endsection
