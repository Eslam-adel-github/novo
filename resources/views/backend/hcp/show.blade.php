...
@section('sub_header')
    @component('backend.layout.components.sub-header')
        ...
        <a href="#" class="kt-subheader__breadcrumbs-link">
            {{ __('main.show') }} {{ __('main.HCP') }} #: {{VarByLang(getData(collect($show),"name"))}}
        </a>

        @slot('toolbar')
            <li class="kt-nav__item">
                <a href="{{ route('admin.HCP.edit', [$show->id]) }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon-edit"></i>
                    <span class="kt-nav__link-text">{{ __('main.edit') }} {{ __('main.HCP') }}</span>
                </a>
            </li>
            <li class="kt-nav__item">
