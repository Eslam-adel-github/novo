...
@section('sub_header')
    ...
    @component('backend.layout.components.sub-header')
        ...
        <a href="#" class="kt-subheader__breadcrumbs-link">
            {{ __('main.add') }}  {{ __('main.event_type') }}
        </a>
    ...
    @component('backend.layout.components.form-portlet')
        ...
        <form class="kt-form" id="kt_form" action="#" method="get">
            <div class="row">
                ...
                <div class="col-xl-8">
                    @include('backend.event_type._partials._fields', [
                        'data' => collect(old()),
                        'action' => 'create',
                    ])
                </div>
...
@section('js_scripts')
    @include('backend.event_type._partials._scripts', [
        'action' => 'create',
        'data' => collect(old()),
        'submitUrl' => route('admin.event_type.store'),
    ])
@endsection
