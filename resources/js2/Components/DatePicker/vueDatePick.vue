<template>
    <div class="vdpComponent" v-bind:class="{vdpWithInput: hasInputElement}">
        ...
        >
        <button
            v-if="editable && hasInputElement && inputValue && allowClear"
            class="vdpClearInput"
            type="button"
            v-on:click="clear"
        ></button>
...
export default {
    ...
    props: {
        ...
        nextMonthCaption: {type: String, default: window.datePickerTranslations.nextMonthCaption},
        prevMonthCaption: {type: String, default: window.datePickerTranslations.prevMonthCaption},
        setTimeCaption: {type: String, default: window.datePickerTranslations.setTimeCaption},
        mobileBreakpointWidth: {type: Number, default: 500},
        weekdays: {
            type: Array,
            default: () => (window.datePickerTranslations.weekdays)
        },
        months: {
            type: Array,
            default: () => (window.datePickerTranslations.monthes)
        },
    ...
    watch: {
        ...
        currentPeriod(currentPeriod, oldPeriod) {
            ...
            this.direction = currentDate !== oldDate
                ? (currentDate > oldDate ? window.datePickerTranslations.next : window.datePickerTranslations.prev)
                : undefined
            ;
