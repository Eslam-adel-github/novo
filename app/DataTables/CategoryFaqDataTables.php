...
class CategoryFaqDataTables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('name', function (CategoryFaq $model) {
            ...
            ->editColumn('actions',function($model){
                ...
                $delete.=sprintf('
                        <script defer>
                            $("#CategoryCommonFaqDelete_%s").on("click",(e)=>{
                                swal.fire({
                                    title: "%s",
                                    text: "%s",
                                    type: "warning",
     ...
     */
    public function query(CategoryFaq $model)
    {
    ...
    {
        return 'categoryfaq_' . date('YmdHis');
    }
}
