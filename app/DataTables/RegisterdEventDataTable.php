...
class RegisterdEventDataTable extends DataTable

{
    ...
    {
        /*
        return $model->with(['userEvents'=>function ($query){
            return $query->where("events_id",request()->route("event_id"))->get();
        }])->newQuery();
        */
        return $model->whereHas('userEvents')->newQuery();
    }
