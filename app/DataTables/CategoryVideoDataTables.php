...
class CategoryVideoDataTables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('name', function (CategoryVideo $model) {
            ...
            ->editColumn('actions',function($model){
                ...
                $delete.=sprintf('
                        <script defer>
                            $("#CategoryVideoDelete_%s").on("click",(e)=>{
                                swal.fire({
                                    title: "%s",
                                    text: "%s",
                                    type: "warning",
     ...
     */
    public function query(CategoryVideo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('category-video-table')
    ...
    {
        return 'categoryvideo_' . date('YmdHis');
    }
}
