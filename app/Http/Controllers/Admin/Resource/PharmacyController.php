...
use App\DataTables\PharmacyDataTables;
...
{
    private $viewPath = 'backend.pharmacy';

    /**
     * @param PharmacyRepository $repository ,
     * @param PharmacyService $service
     */
    public function __construct(PharmacyRepository $repository, PharmacyService $service)
    {
     ...
     * @return Response
     */
    public function index(PharmacyDataTables $dataTable)
    {
        return $dataTable->render("{$this->viewPath}.index", [
            'title' => __('main.show-all') . ' ' . __('main.pharmacies'),
        ]);
    }
    /**
    ...
    public function create()
    {
        return view("{$this->viewPath}.create", [
            'title' => __('main.add')  . ' ' . __('main.pharmacy'),
        ]);
    }
    ...
    public function show($id)
    {
        ...
        if ($show) {
            return view("{$this->viewPath}.show", [
                'title' => __('main.show') . ' ' . __('main.pharmacy').' : ' . VarByLang(getData(collect($show),"name")),
                'show' => $show,
            ]);
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($object) {
            return view("{$this->viewPath}.edit", [
                'title' => __('main.edit') . ' ' . ' ' . __('main.pharmacy').' : ' . VarByLang(getData(collect($object),"name")),
                'edit' => $object,
            ]);
        }
    }
