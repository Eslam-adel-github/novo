...
use App\DataTables\EventTypeDataTables;
...
{
    private $viewPath = 'backend.event_type';

    /**
     * @param EventTypeRepository $repository ,
     * @param EventTypeService $service
     */
    public function __construct(EventTypeRepository $repository, EventTypeService $service)
    {
     ...
     * @return Response
     */
    public function index(EventTypeDataTables $dataTable)
    {
        return $dataTable->render("{$this->viewPath}.index", [
            'title' => __('main.show-all') . ' ' . __('main.events_type'),
        ]);
    }
    /**
    ...
    public function create()
    {
        return view("{$this->viewPath}.create", [
            'title' => __('main.add')  . ' ' . __('main.event_type'),
        ]);
    }
    ...
    public function show($id)
    {
        ...
        if ($show) {
            return view("{$this->viewPath}.show", [
                'title' => __('main.show') . ' ' . __('main.event_type'). ' : ' . VarByLang(getData(collect($show),"name")),
                'show' => $show,
            ]);
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($object) {
            return view("{$this->viewPath}.edit", [
                'title' => __('main.edit') . ' ' . ' ' . __('main.event_type').' : ' . VarByLang(getData(collect($object),"name")),
                'edit' => $object,
            ]);
        }
    }
