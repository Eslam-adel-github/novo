...
class UploadHelper
{
    ...
    /**
     * MultiUploadUpdate
     * @param  array  $oldImages has old images with the ones you want to remove
     * @param  array  $newImages has the ones to add on the server
     * @param  string $currentImages the current in the database field
     * @param  string $dir
     * @param  string $checkFunction
     * @return string
     */
