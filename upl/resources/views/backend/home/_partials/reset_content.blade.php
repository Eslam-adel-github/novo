                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="kt_widget5_tab1_content" aria-expanded="true">
                        <div class="kt-widget5">
                            @foreach($most_seller_products_month as$key=>$value)
                                <div class="kt-widget5__item">
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__pic">
                                        <img class="kt-widget7__img"
                                            src="{{ asset('uploads/media/products/product27.jpg') }}" alt="">
                                    </div>
                                    <div class="kt-widget5__section">
                                        ...
                                        <p class="kt-widget5__desc">
                                            Category:{{optional($value->product->category)->name}}
                                        </p>
                                        <div class="kt-widget5__info">
                                            <span>Vendor:</span>
                                            <span class="kt-font-info">{{optional($value->product)->vendor->name}}</span>
                                            <br>
                                            <span>Product:</span>
                                            <span class="kt-font-info">{{$value->product->product}}</span>
                                            <br>
                                            <span>Product Type:</span>
                                            <span class="kt-font-info">{{$value->product->product_type}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__stats">
                                        <span class="kt-widget5__number">{{$value->count}}</span>
                                        <span class="kt-widget5__sales">sales</span>
                                    </div>
                                    <div class="kt-widget5__stats">
                                        <span class="kt-widget5__number">{{round($value->product->reviews()->avg("rate"),2)}}</span>
                                        <span class="kt-widget5__votes">Reviews (Avg)</span>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                    ...
                    <div class="tab-pane" id="kt_widget5_tab2_content">
                        <div class="kt-widget5">
                            @foreach($most_seller_products_at_all as$key=>$value)
                                <div class="kt-widget5__item">
                                    <div class="kt-widget5__content">
                                        <div class="kt-widget5__pic">
                                            <img class="kt-widget7__img"
...
@admin
<div class="row">
    <div class="col-lg-6 col-xl-4 order-lg-3 order-xl-1">
        <div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        New Registerations (users,vendor)
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                            ...
                            @foreach($users as$key=>$value)
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="{{ asset('uploads/media/users/100_4.jpg') }}" alt="">
                                    </div>
                                    ...
                                    <a href="{{route(userType()::prefix()."users.show",[$value->id])}}" class="btn btn-sm btn-label-brand btn-bold">Show Profile</a>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="tab-pane" id="kt_widget4_tab2_content">
                        <div class="kt-widget4">
                             ...
                             @foreach($vendor as$key=>$value)
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="{{ asset('uploads/media/users/100_13.jpg') }}" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            {{$value->name}}
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="kt_widget2_tab1_content">
                        <div class="kt-widget2">
                            @foreach($request_today as$key=>$value)
                                <div class="kt-widget2__item kt-widget2__item--warning">
                                    ...
                                    <div class="kt-widget2__info">
                                        <a href="{{route(userType()::prefix()."requests.show",[$value->id])}}" class="kt-widget2__title">
                                            {{Str::limit($value->business_description,20)}}
                                        </a>
                                    ...
                                    <div class="kt-widget2__actions">
                                        <a href="{{route(userType()::prefix()."requests.show",[$value->id])}}" class="btn btn-clean btn-sm btn-icon btn-icon-md"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                                            <ul class="kt-nav">
                                                <li class="kt-nav__item">
                                                    <a href="{{route(userType()::prefix()."requests.show",[$value->id])}}" class="kt-nav__link">
                                                        <i  class="kt-nav__link-icon flaticon2-line-chart"></i>
                                                        <span class="kt-nav__link-text">Show Request</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div class="tab-pane" id="kt_widget2_tab2_content">
                        <div class="kt-widget2">
                            @foreach($request_previous as$key=>$value)
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g stroke="none" stroke-width="1" fill="none"
                                            ...
                                            <rect fill="#000000" opacity="0.3"
                                                ...
                                                x="11" y="11" width="3" height="13" rx="0.5"></rect>
                                        </g>
                                    </svg> </div>
                                <div class="kt-notification__item-details">
                                    <div class="kt-notification__item-title">
                ...
                <div class="kt-widget3">
                        ...
                        <div class="kt-widget3__header">
                            <div class="kt-widget3__user-img">
                                <img class="kt-widget3__img"
                                    src="{{ asset('uploads/media/users/user1.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="kt-widget3__item">
                        <div class="kt-widget3__header">
                            <div class="kt-widget3__user-img">
                                <img class="kt-widget3__img"
                                    src="{{ asset('uploads/media/users/user4.jpg') }}" alt="">
                            </div>
                            <div class="kt-widget3__info">
                                <a href="#" class="kt-widget3__username">
                                    Lebron King James
                    ...
                    <div class="kt-widget3__item">
                        <div class="kt-widget3__header">
                            <div class="kt-widget3__user-img">
                                <img class="kt-widget3__img"
                                    src="{{ asset('uploads/media/users/user5.jpg') }}" alt="">
                            </div>
                            <div class="kt-widget3__info">
                                <a href="#" class="kt-widget3__username">
                                    Deb Gibson
...
<div style="display:none" class="row">
    <div class="col-lg-6 mb-4">
        <div class="card shadow mb-4" id="projects_content" data-intro="projects projects"
            data-description="Show projects projects">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Projects</h6>
            </div>
            <div class="card-body">
                <div style="padding: 10px 10px 1px 10px;margin-bottom: 15px;"
                    id="projects_server_migration" data-intro="server migration"
                    data-description="server migration">
                ...
                <div style="padding: 10px 10px 1px 10px;margin-bottom: 15px;" id="sales_tracking"
                    data-intro="sales_tracking" data-description="sales_tracking">
                ...
                <div style="padding: 10px 10px 1px 10px;margin-bottom: 15px;" id="Customer_Database"
                    data-intro="Customer Database" data-description="Customer Database">
                ...
                <div style="padding: 10px 10px 1px 10px;margin-bottom: 15px;" id="Payout_Details"
                    data-intro="Payout Details" data-description="Payout Details">
                ...
                <div style="padding: 10px 10px 1px 10px;margin-bottom: 15px;" id="Complete"
                    data-intro="Complete" data-description="Complete">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card shadow mb-4" id="illustration" data-intro="illustration" data-description="illustration">
            <div class="card-header py-3">
        ...
        <div class="card shadow mb-4" id="development_approch" data-intro="Development Approach"
            data-description="Development Approach">
            <div class="card-header py-3">
    ...
    </div><!-- Illustrations & Development Approach-->
</div>
