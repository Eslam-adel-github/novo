...
<link rel="stylesheet" href="https://unpkg.com/vue-multiselect@2.1.0/dist/vue-multiselect.min.css">
    ...
    @component('backend.layout.components.sub-header')
        @slot('title')
            {{__('main.edit') . ' ' . __('main.rethink_obesity') . ' : ' . $title }}
        @endslot
    ...
    @component('backend.layout.components.form-portlet')
        ...
        <form class="kt-form" id="kt_form" action="#" method="get">
            <div class="row">
                ...
                <div class="col-xl-8">
                    @include('backend.rethink_obesity._partials._fields', [
                        'data' => collect($edit),
                        'action' => 'edit',
                    ])
                </div>
...
@section('js_scripts')
    @include('backend.rethink_obesity._partials._scripts', [
        'action' => 'edit',
        'data' => collect($edit),
        'submitUrl' => route('admin.rethink_obesity.update', [$edit->id]),
    ])
@endsection
